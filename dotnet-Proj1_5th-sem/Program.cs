...
namespace dotnettutorials
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            // var implicitConversion = new ImplicitTypeConversions();
            //implicitConversion.run();

            // var explicitConversion = new ExplicitConversion();
            //explicitConversion.run();

            //var statementExample = new StatementExample();
            //statementExample.run();

            // var conditionStatement = new ConditionStatement();
            // conditionStatement.run();

            // var ArrayExamples = new ArrayExamples();
            //  ArrayExamples.Run();

            // var teacher1 = new CollegeManagement.Teachers();
            // teacher1.Run();

            // var user1 = new CollegeManagement.User();
            // user1.Run();

            // var teacher2 = new SchoolManagement.Teachers();
            // teacher2.Run();

            // var user2 = new SchoolManagement.User();
            // user2.Run();

            // var workoutPlan = new FitnessTracker.Workout.WorkoutPlan();
            // workoutPlan.Run();
